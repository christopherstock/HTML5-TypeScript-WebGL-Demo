    ...
    ********************************************************************************/
    class Lib3ds
    {
        ...
        public      static          POINTS_SCALATION        :number                     = 0.5;
...
*/
                ...
                for ( var i:number = 0; i < faces3ds.length; ++i )
                {
                    ...
                    (
                        ...
                        new LibVertex(   faces3ds[ i ].vertex1.x,     -faces3ds[ i ].vertex1.z,    faces3ds[ i ].vertex1.y, 0.0, 1.0 ),
                        new LibVertex(   faces3ds[ i ].vertex2.x,     -faces3ds[ i ].vertex2.z,    faces3ds[ i ].vertex2.y, 0.0, 1.0 ),
                        new LibVertex(   faces3ds[ i ].vertex3.x,     -faces3ds[ i ].vertex3.z,    faces3ds[ i ].vertex3.y, 0.0, 1.0 ),
/*
