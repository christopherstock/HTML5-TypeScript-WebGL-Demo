    ...
    *****************************************************************************/
    class MfgDebug
    {
        ...
        public      static  soundLoader                 :LibDebug                       = new LibDebug( true    && MfgSettings.MODE == MfgDebugSettings.MODE_DEBUG );
        ...
        public      static  textLoader                  :LibDebug                       = new LibDebug( true    && MfgSettings.MODE == MfgDebugSettings.MODE_DEBUG );
    }
